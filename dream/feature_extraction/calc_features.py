...
from dream.utils.progress_bar import display_progress_bar, progress_bar_notebook
...
def dataset_features_extractor(main_directory, feat_dict, verbose=1, **kwargs):
    ...
    See below:
        ...
        * *output_directory* (``String``) --
            Output directory
            (default: ``'output_directory', str(Path.home()) + '/dream_output'``)
    ...
    output_directory = kwargs.get('output_directory', str(Path.home()) + '/dream_output')
    ...
    for _type in domain:
        ...
        for feat in domain_feats:
            ...
            if dict_features[_type][feat]["use"] == "yes":
                ...
                if func_total.find("dream.") == 0:
                    func_total = func_total.replace("dream.", "")
