...
def generate_modelcard(config_file_path,output_path,version_num):
  ...
  bootstrap_css_path = files('dreams').joinpath('assets/vendor/bootstrap/css/bootstrap.min.css')
  font_awesome_css_path = files('dreams').joinpath('assets/vendor/font-awesome/css/all.min.css')
  magnific_popup_css_path = files('dreams').joinpath('assets/vendor/magnific-popup/magnific-popup.min.css')
  highlight_css_path = files('dreams').joinpath('assets/vendor/highlight.js/styles/github.css')
  custom_stylesheet_path = files('dreams').joinpath('assets/css/stylesheet.css')

 
  #Java script   
  jquery_path = files('dreams').joinpath('assets/vendor/jquery/jquery.min.js')
  bootstrap_path = files('dreams').joinpath('assets/vendor/bootstrap/js/bootstrap.bundle.min.js')
  highlight_js_path = files('dreams').joinpath('assets/vendor/highlight.js/highlight.min.js')
  easing_path = files('dreams').joinpath('assets/vendor/jquery.easing/jquery.easing.min.js')
  magnific_popup_path = files('dreams').joinpath('assets/vendor/magnific-popup/jquery.magnific-popup.min.js')
  theme_js_path = files('dreams').joinpath('assets/js/theme.js')
